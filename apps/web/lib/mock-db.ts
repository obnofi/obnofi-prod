  ...
  return {
    pages: new Map([
      ["page-1", {
        ...
        type: "document", icon: null, parentId: null, workspaceId: "ws-1",
        createdAt: new Date().toISOString(), updatedAt: new Date().toISOString(),
        isPublic: false, shareId: null, sharePassword: null,
      }],
      ["page-2", {
        id: "page-2", title: "Project Clearing", content: null, type: "canvas", icon: null,
      ...
      ["page-3", {
        id: "page-3", title: "Tasks", content: null, type: "database", icon: null,
