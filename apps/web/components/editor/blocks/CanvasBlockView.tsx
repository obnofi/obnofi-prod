...
// Module-level caches shared across all CanvasBlock instances
export const canvasPageCache = new Map<string, Page>();
export const canvasPageRequestCache = new Map<string, Promise<Page | null>>();
...
export function CanvasBlockView(props: ReactNodeViewProps) {
  ...
  const { canvasPage, isCreating, isLoading } = useCanvasPageState({
    pageId,
    workspaceId,
    parentPageId,
    autoCreate,
